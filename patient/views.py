...
from stringfunction.string_conversion import to_upper_case
...
def patient_signup_view(request):
    ...
    if request.method=='POST':
        ...
        if userForm.is_valid() and patientForm.is_valid():
            user=userForm.save()
            #custom library used here
            user.first_name = to_upper_case(userForm.cleaned_data['first_name'])
            user.last_name = to_upper_case(userForm.cleaned_data['last_name'])
            #custom library used here ends
            ...
            #custom library used here
            patient.address = to_upper_case(patientForm.cleaned_data['address'])
            #custom library used here ends
            patient.save()
